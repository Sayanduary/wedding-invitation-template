    ...
    <div className="min-h-screen h-auto flex flex-col items-center justify-center gap-6 sm:gap-10 text-center bg-transparent px-4 py-10 sm:py-0">
      ...
      <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-2xl sm:text-4xl">
        <div className="flex flex-col items-center gap-2">
          <div className="border rounded p-3 sm:p-5 w-16 h-16 sm:w-20 sm:h-20 text-[#5c2018] font-['Playfair_Display']">
            {timeLeft.days}
          </div>
          <div className="text-sm text-[#5c2018]">DAYS</div>
        </div>
        <div className="flex flex-col items-center gap-2">
          <div className="border rounded p-3 sm:p-5 w-16 h-16 sm:w-20 sm:h-20 text-[#5c2018] font-['Playfair_Display']   ">
            {timeLeft.hours}
          </div>
          <div className="text-sm text-[#5c2018]">HOURS</div>
        </div>
        <div className="flex flex-col items-center gap-2">
          <div className="border rounded p-3 sm:p-5 w-16 h-16 sm:w-20 sm:h-20 text-[#5c2018] font-['Playfair_Display']">
            {timeLeft.minutes}
          </div>
          <div className="text-sm text-[#5c2018]">MINUTES</div>
        </div>
        <div className="flex flex-col items-center gap-2">
          <div className="border rounded p-3 sm:p-5 w-16 h-16 sm:w-20 sm:h-20 text-[#5c2018] font-['Playfair_Display']">
            {timeLeft.seconds}
          </div>
          <div className="text-sm text-[#5c2018]">SECONDS</div>
        </div>
      </div>
      <div className="font-light text-[#5c2018] text-shadow-mauve-500 text-sm">
        Until The Big Day
      </div>

      <div className="flex flex-col items-center gap-2 mt-6 sm:mt-10">
        <h1 className="text-xl sm:text-2xl font-['Playfair_Display'] text-[#5c2018] px-3">
      ...
      <div>
        <h1 className="text-lg sm:text-xl font-['Playfair_Display'] text-[#5c2018]">
          Venue Name
        </h1>
        <p className="text-base sm:text-lg text-[#5c2018] font-light px-3">
