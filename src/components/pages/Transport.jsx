...
function Transport() {
  return (
    <div className="min-h-screen h-auto flex flex-col gap-4 sm:gap-5 items-center bg-[#faf8f5] px-6 py-10 sm:p-20 text-center">
      ...
      <p className="text-[#5c2018] mt-8 sm:mt-10 font-['Playfair_Display'] italic text-2xl sm:text-3xl max-w-3xl">
